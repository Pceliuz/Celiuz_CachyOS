...
Lo que fue `SIGUIENTE.md` hasta el 2026-09-25: las crónicas de cada sesión, con
lo que se midió, lo que se descartó y por qué. Se movió aquí entero, sin tocar,
cuando `SIGUIENTE.md` pasó de 1238 líneas y dejó de servir para «por dónde
seguir». Lo nuevo va arriba de la sesión siguiente en `SIGUIENTE.md`, y cuando
se cierra, baja aquí.

Para buscar algo concreto: `grep -n "palabra" HISTORIAL.md`.
